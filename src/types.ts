...
export interface User {
  id: string;
  username: string;
  networkId: string; // The specific Grid Room (e.g. 'Office-Net', 'Global')
  points: number;
  mode: UserMode;
  cpuUsage: number;
  memoryUsage: number;
...
export type MessageType = 'HELLO' | 'HEARTBEAT' | 'TASK_OFFER' | 'TASK_ACCEPT' | 'TASK_PROGRESS' | 'TASK_COMPLETE' | 'LEAVE';
